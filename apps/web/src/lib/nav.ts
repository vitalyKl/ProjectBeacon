...
export const APP_NAV = [
  ...
  { href: "/app/context", label: "Context", message: "nav.context", group: "work" },
  ...
  { href: "/app/files", label: "Files", message: "nav.files", group: "utility" },
  { href: "/app/learn", label: "Learn", message: "nav.learn", group: "utility" },
