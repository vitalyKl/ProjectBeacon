export const en = {
  ...
  "reports.evalMetrics": "Eval metrics",
  "reports.evalMetricsIntro":
    "Ingest a context-effectiveness eval report to see tokens and turns saved by compiled briefs.",
  "reports.emptyEvalMetrics": "No eval metrics yet. Ingest an A1 eval report to see cost savings.",
  "reports.evalSavedTokens": "{count} tokens saved",
  "reports.evalSavedTurns": "{count} turns saved",
  "reports.evalBriefPasses": "{passing}/{total} with brief passed",
  "reports.evalWithoutBriefPasses": "{passing}/{total} without brief passed",
  "reports.evalAvgTokens": "Avg tokens (with brief): {count}",
  "reports.evalAvgTurns": "Avg turns (with brief): {count}",
  "reports.evalFixtureBrief": "With brief",
  "reports.evalFixtureNoBrief": "Without brief",
  "reports.evalBetterPass": "Brief improved pass/fail",
  "reports.evalWorsePass": "Brief caused regression",
  "reports.ingestFailed": "failed to ingest eval report",
  "reports.ingest": "Ingest eval report",
  "reports.ingesting": "Ingesting…",
  "learn.title": "Learn",
  "learn.intro":
  ...
  "board.sort": "Sort by",
  "board.sortByPriority": "Priority",
  "board.sortByName": "Name",
  "board.sortByUpdated": "Updated",
  ...
  "task.title": "Task",
  "task.githubPrs": "Pull requests",
  "task.githubPrsHint":
    "Pull requests linked to this task's GitHub issue. Shows diff stats (files changed, additions, deletions).",
  "task.githubPrsEmpty": "No pull requests found for the linked GitHub issue.",
  "task.githubPrsDiff": "Diff",
  "task.githubPrsFiles": "files changed",
  "task.githubPrsAdditions": "additions",
  "task.githubPrsDeletions": "deletions",
  "task.githubPrsMatched": "brief match",
  ...
  "webhooks.hint":
    "Outbound POST requests when an agent-owned task transitions to blocked. Secrets are stored in the control plane; never printed in logs or git.",
  "webhooks.add": "Add webhook URL",
  "webhooks.urlPlaceholder": "https://hooks.slack.com/... or similar",
  "webhooks.save": "Save webhook",
  "webhooks.removing": "Removing…",
  "webhooks.remove": "Remove",
  "webhooks.saving": "Saving…",
  "webhooks.failedSave": "failed to save webhook settings",
  ...
  "context.budget": "{used} / {requested} tokens",
  "context.overflow": "Budget exceeded — some sections were trimmed.",
  "context.droppedSection": "Dropped: {name}",
  "context.diff": "Diff vs {label}",
  "context.diffOnlyInCurrent": "Only in current:",
  "context.diffOnlyInRevision": "Only in {label}:",
  "context.diffCommon": "{count} sections unchanged.",
  "context.saved": "Saved.",
  ...
  "wizard.mcpToolCallTail": "Agent activity",
  "wizard.mcpToolCallTailHint": "Watch for the agent's first tool calls once it connects. A ping or list_tools call confirms it's working.",
  "wizard.noActivity": "No activity yet. The agent will appear here once connected.",
  "wizard.activityPing": "ping",
  "wizard.activityListTools": "tools/list",
  "wizard.activityStartWork": "start_work",
